...
from setting import LFASR_APP_ID, LFASR_SECRETKEY, FILE, ROOT, UPLOAD_FILE_DIR, DOWNLOAD_DIR, LYRICS_DIR, AUDIO_DIR, \
...
async def concurrentTask(upload_file_paths, lyrics_file_name, is_cut, max_concurrency):
    ...
    tasks = [
        asyncioExtractLyricsPart(
            ...
            lyrics_file_name=lyrics_file_name,
            is_cut=is_cut,
            semaphore=semaphore) for upload_file_path in upload_file_paths]
